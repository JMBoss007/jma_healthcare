...
export const AppointmentForm = ({
  ...
  // ✅ FIXED: added correct zodResolver usage
  ...
  // ✅ FIXED: proper type for onSubmit
          ...
          <>
            ...
            >
              <CustomFormField
                ...
                control={form.control}
                name="reason"
                label="Client's Appointment reason"
